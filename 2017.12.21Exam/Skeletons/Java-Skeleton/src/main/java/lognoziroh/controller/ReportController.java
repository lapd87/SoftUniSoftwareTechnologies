...
public class ReportController {
	...
	public String createProcess(Model model, ReportBindingModel reportBindingModel, BindingResult bindingResult) {
		...
		if (reportBindingModel.getOrigin().equals("") ||
		...
		Report r = new Report();
		r.setStatus(reportBindingModel.getStatus());
		r.setMessage(reportBindingModel.getMessage());
		r.setOrigin(reportBindingModel.getOrigin());
